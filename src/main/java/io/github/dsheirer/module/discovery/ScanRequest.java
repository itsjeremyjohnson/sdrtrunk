 ...
 *
 * <p>This is a plain value record — it carries no hardware references.  The stepped-sweep
 * decision (in-band vs wide-span) is made by {@link BandScanController}, which holds its
 * own optional {@link TunerControl} reference set at construction time.</p>
 *
