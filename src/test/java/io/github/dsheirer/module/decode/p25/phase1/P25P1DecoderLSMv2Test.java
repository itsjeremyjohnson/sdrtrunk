...
class P25P1DecoderLSMv2Test
{
    ...
    @Test
    void lsmV2ReusesEstablishedNoiseFloorOnCarrierReturn()
    {
        P25P1DecoderLSMv2 decoder = new P25P1DecoderLSMv2();
        decoder.detectTransmissionBoundary(samples(4000, 1.0f), samples(4000, 0.0f));
        decoder.detectTransmissionBoundary(samples(20000, 0.001f), samples(20000, 0.0f));
    ...
    @Test
    void c4fmReusesEstablishedNoiseFloorAfterShortSilence()
    {
        P25P1DecoderC4FM decoder = new P25P1DecoderC4FM();
        decoder.detectTransmissionBoundary(samples(4000, 1.0f), samples(4000, 0.0f));
